...
\begin{frame}{More perspective}
  \begin{itemize}
    \item Electrically large objects: $N_s > 10^8$
    \item Memory required $\sim \mathcal{O}(N_s^2) \approx \SI{1000}{\tera\byte}$
    \item Time required
      \begin{itemize}
        \item Potential evaluation: $\mathcal{O}(N_s^2) \to \SI{26}{\hour}$ (at \SI{105}{\giga\flops})
...
\begin{frame}{Spatial acceleration: Uniform grid}
  \begin{columns}
    \column{0.75\textwidth}
      \begin{block}{Consider an easier problem}
        \begin{equation*}
