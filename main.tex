  ...
  \begin{columns}
    \column{0.75\textwidth}
      \begin{block}{Consider an easier problem (without dynamics)}
        \begin{equation*}
          \vb{E}\qty(\vb{r}_\text{obs}) = \sum_\text{src} \overline{g}\qty(\vb{r}_\text{obs}, \vb{r}_\text{src}) \vb{J}\qty(\vb{r}_\text{src})
        \end{equation*}
      \end{block}
    \begin{itemize}
      \item Physics imposes translational invariance: $\overline{g}(\vb{r}_\text{obs}, \vb{r}_\text{src}) = \overline{g}(\vb{r}_\text{obs} - \vb{r}_\text{src})$
    ...
    \begin{center}
      ...
      \vfill
      \begin{equation*}
        \vb{E} = \underbrace{\overbrace{\overline{G}}^\text{FFT} \overbrace{\vb{J}}^\text{FFT}}_\text{IFFT}
      \end{equation*}
    \end{center}
  \end{columns}
...
\begin{frame}{Spatial acceleration: nonuniform grid}
  \begin{columns}
    \column{0.75\textwidth}
