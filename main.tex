...
\begin{frame}{Model of a quantum dot}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{align*}
        \dv{\hat{\rho}}{t} = \commutator{\hat{\mathcal{H}}}{\hat{\rho}} - \hat{\mathcal{D}}\qty{\hat{\rho}}
      \end{align*}
      \begin{gather*}
        \hat{\mathcal{H}} = \mqty( 0 & \vb{d} \cdot \vb{E} \\ \vb{d} \cdot \vb{E} & \hbar \omega_0) \qquad \hat{\mathcal{D}} = \mqty(\rho_{11}/T_1 & \rho_{01}/T_2 \\ \rho_{10}/T_2 & \rho_{11}/T_1)
      \end{gather*}
    \end{column}
    \begin{column}{0.4\textwidth}
      \begin{figure}
        \centering
        \begin{tikzpicture}[>=Triangle, scale=0.9]
          \draw (0,0) circle (1.5cm);
          \draw (0,0) ellipse (1.5cm and 0.5cm);
          \draw [->] (0, 0) -- (0,1.5) node[above] {$\ket{1}$};
          \draw [->] (0,0) -- (1.5,0) node[right] {};
          \draw [->] (0,0) -- (-0.5,{-sqrt(2)/3}) node[below] {};

          \draw[densely dotted] (0,0) -- (0.4,0.8) node[right] {$\ket{\psi}$};
          \node at (0.4, 0.8) {\tiny\textbullet};
          \node[below] at (0, -1.5) {$\ket{0}$};
        \end{tikzpicture}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}[c, fragile]{Example evolution}
  \begin{figure}
    \centering
    \input{figures/example_evolution.tex}
  \end{figure}
\end{frame}
