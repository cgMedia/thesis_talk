...
\usetikzlibrary{positioning, shapes.geometric, arrows, arrows.meta, spy, shadows, mindmap}
    ...
    \column{0.5\textwidth}
      \begin{itemize}
        \item Maxwell's equations govern electromagnetic phenomena
          ...
          \end{itemize}
        \item Analytic solutions unavailable
        \item Simulate!
          \begin{itemize}
            \item How to represent equations?
            \item speeed $\leftrightarrow$ precision
          \end{itemize}
      \end{itemize}
    \column{0.5\textwidth}
    \begin{center}
...
\begin{frame}{CEM tools}
  \begin{center}
    \input{figures/de_ie_mindmap}
  \end{center}
\end{frame}

\begin{frame}{Surface integral equations}
  \begin{columns}
    \column{0.6\textwidth}
    \begin{block}{Convolutional operators}
      \begin{equation*}
        \vb{E}(\vb{r}, t) = \vb{E}_\text{inc}(\vb{r}, t) +
        \begin{cases}
          \mathcal{L}\qty{\vb{J}(\vb{r}, t)} &\text{(linear EM)} \\
          \mathcal{L}\qty{\vb{J}\big(\vb{E}(\vb{r}, t))} &\text{(my work)}
        \end{cases}
      \end{equation*}
      \begin{itemize}
        \item Dispersion-free
        \item Discretize $\vb{J}$, $\vb{E}$ in space ($N_s$) and time ($N_t$)
        \item Iterative solution
          \begin{itemize}
            \item $\mathcal{O}(N_t N_s^2)$ (na\"ive)
            \item $\mathcal{O}(N_t N_s \log N_s)$ (optimal)
          \end{itemize}
      \end{itemize}
    \end{block}
    ...
    \column{0.4\textwidth}
      \begin{center}
        \input{figures/surface_current}\\ \vspace{0.1cm}
        \input{figures/dense_communication}
        \input{figures/tree_communication}
      \end{center}
  \end{columns}
\end{frame}
